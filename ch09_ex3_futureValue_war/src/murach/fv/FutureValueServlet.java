...
public class FutureValueServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request,
        ...
        double futureValue=calculations.get(calculations.size()-1).getFutureValue();
        ...
        request.setAttribute("investmnt", investment);
        request.setAttribute("intRate", interestRate);
        request.setAttribute("futValue", futureValue);
